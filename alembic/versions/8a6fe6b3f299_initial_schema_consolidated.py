...
Revision ID: 8a6fe6b3f299
Revises: 
Create Date: 2026-06-24 09:44:34.955278
...
def downgrade() -> None:
    ...
    sa.Column('favorite_team_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['favorite_team_id'], ['teams.id'], name=op.f('users_favorite_team_id_fkey')),
